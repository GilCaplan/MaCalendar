...
_Generated 2026-09-03 21:49 · 92 commands · scratch DB · vocabulary 374 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Time to first result:** p50 3.6 s · p95 11.1 s  ·  **time to settled:** p50 10.6 s · p95 20.3 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| adversarial | 5 | 100% | 100% | 100% | 100% | 3.0 s | 4.9 s | 10.5 s |
| events | 41 | 95% | 95% | 93% | 100% | 4.5 s | 12.5 s | 12.1 s |
| from-chats | 15 | 87% | 87% | 88% | 100% | 4.4 s | 7.5 s | 12.1 s |
| mixed | 3 | 100% | 100% | 100% | 100% | 0.1 s | 15.0 s | 1.6 s |
| query | 3 | 100% | 100% | 100% | 100% | 0.0 s | 0.0 s | 0.8 s |
| tasks | 18 | 89% | 89% | 95% | 79% | 0.0 s | 6.7 s | 1.1 s |
| update-delete | 7 | 86% | 86% | 86% | 100% | 0.0 s | 4.8 s | 1.1 s |

## By parse path

| Path | n | quick ✓ | settled ✓ | recall | precision | first p50 | first p95 | LLM ms p50 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| rule | 39 | 97% | 97% | 98% | 100% | 0.0 s | 1.6 s | 0 |
| hybrid | 8 | 75% | 75% | 90% | 91% | 3.8 s | 10.4 s | 3759 |
| llm | 45 | 91% | 91% | 90% | 94% | 5.0 s | 13.3 s | 4924 |
...
|---|---:|---:|---:|
| multi/self-correction-count | 1 | 0% | 10.5 s |
| multi/same-due-date | 1 | 0% | 6.4 s |
| update/move-by-time | 1 | 0% | 3.8 s |
| multi/interleaved-clauses | 1 | 0% | 7.6 s |
| multi/disfluent-duration | 1 | 0% | 11.1 s |
| chat-phrasing | 15 | 87% | 4.4 s |
| single/place | 1 | 100% | 4.1 s |
| single/hebrew-name | 1 | 100% | 0.0 s |
| single/full-name | 1 | 100% | 0.1 s |
| multi/same-list | 2 | 100% | 0.0 s |
| event+task | 1 | 100% | 0.1 s |
| recurring/weekly | 2 | 100% | 4.3 s |
...
| multi/same-day-3 | 2 | 100% | 14.2 s |
| task-not-event | 1 | 100% | 0.0 s |
| ambiguous/no-time | 1 | 100% | 3.0 s |
| single/due-tomorrow | 1 | 100% | 0.0 s |
| single/weekday | 1 | 100% | 4.1 s |
| single | 2 | 100% | 0.0 s |
| multi/different-due-dates | 1 | 100% | 6.5 s |
...
| multi/same-list-3 | 1 | 100% | 3.8 s |
| multi/shared-verb | 1 | 100% | 0.0 s |
| delete/by-title | 1 | 100% | 0.0 s |
| generated/single | 12 | 100% | 5.0 s |
| misheard-names | 1 | 100% | 4.6 s |
| single/disfluency | 1 | 100% | 5.8 s |
| delete/by-time | 1 | 100% | 0.0 s |
| single/inferred-tag | 1 | 100% | 0.0 s |
| past-tense-noise | 1 | 100% | 4.9 s |
| query/tomorrow | 1 | 100% | 0.0 s |
| single/hebrew-term | 2 | 100% | 3.6 s |
| multi/different-days | 2 | 100% | 11.0 s |
| single/next-weekday | 1 | 100% | 1.7 s |
| recurring/daily | 1 | 100% | 4.2 s |
| single/internal-and | 1 | 100% | 0.0 s |
| multi/shared-verb-people | 1 | 100% | 0.0 s |
| single/due-weekday | 1 | 100% | 0.0 s |
| single/terse | 1 | 100% | 3.3 s |
| single/general-list | 1 | 100% | 0.0 s |
| update/extend | 1 | 100% | 5.2 s |
| task+event | 1 | 100% | 0.1 s |
| single/spoken-time | 1 | 100% | 3.7 s |
| update/move-day | 1 | 100% | 0.0 s |
| single/range | 1 | 100% | 4.5 s |
| multi/different-days-3 | 1 | 100% | 11.2 s |
| single/stop-word | 1 | 100% | 1.6 s |
...
### events · multi/disfluent-duration · `llm` · 11.1 s
...
### events · multi/self-correction-count · `llm` · 10.5 s
...
### update-delete · update/move-by-time · `hybrid` · 3.8 s
...
### from-chats · chat-phrasing · `llm` · 5.2 s
...
### from-chats · chat-phrasing · `rule` · 2.1 s
...
| 14.6 | llm | set a meeting tomorrow at 1 pm, another one at 4 pm and then pizza at 6:30 pm to |
| 13.8 | llm | on thursday I have Shacharit at 6:30 am, a lecture at 10 and dinner with Danny a |
| 12.5 | hybrid | set lunch with Tal on monday at noon and coffee with Ezra on friday at 9 |
| 11.2 | llm | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 11.1 | llm | set a meeting at 4pm today, but it is only 20 minutes meeting with one moment me |
| 10.5 | llm | a meeting for me tomorrow at two one sorry one pm and four pm and then another o |
| 9.6 | llm | walk Kyra the dog at 3:30 pm today and then go to shul for Mincha Maariv at 7:30 |
| 9.5 | llm | meeting with Ravid tomorrow at 2 pm and dentist on thursday at 9 am |
| 8.9 | llm | tomorrow gym at 7 am and a meeting with Tal at 11 |

## Raw

Full per-case JSON: `DOCUMENTATION/experiments/memory_scaling/C_k0_shared.md.json`