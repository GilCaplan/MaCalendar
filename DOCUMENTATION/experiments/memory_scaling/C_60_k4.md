...
_Generated 2026-09-03 22:04 · 92 commands · scratch DB · vocabulary 374 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Recall 94%** (106/113 expected items produced correctly) · **precision 96%** (110/113 produced actions were expected, plus 2 extra task rows beyond what was expected) — accuracy alone doesn't distinguish missing something asked for from producing something extra
- **Time to first result:** p50 4.1 s · p95 10.3 s  ·  **time to settled:** p50 11.8 s · p95 19.9 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| adversarial | 5 | 100% | 100% | 100% | 100% | 4.5 s | 5.8 s | 12.3 s |
| events | 41 | 95% | 95% | 93% | 100% | 5.0 s | 11.0 s | 12.5 s |
| from-chats | 15 | 93% | 93% | 94% | 100% | 4.5 s | 7.7 s | 12.3 s |
| mixed | 3 | 100% | 100% | 100% | 100% | 0.1 s | 14.7 s | 5.7 s |
| query | 3 | 100% | 100% | 100% | 100% | 0.0 s | 0.0 s | 2.6 s |
| tasks | 18 | 89% | 89% | 95% | 79% | 0.0 s | 6.5 s | 4.2 s |
| update-delete | 7 | 86% | 86% | 86% | 100% | 0.0 s | 5.6 s | 5.4 s |
...
| hybrid | 9 | 78% | 78% | 91% | 91% | 5.9 s | 9.8 s | 5847 |
| llm | 44 | 93% | 93% | 92% | 94% | 5.1 s | 10.9 s | 5056 |

## Quick answer vs self-check

- Self-check ran on 92 commands; it proposed a correction on 29 (0 applied).
...
|---|---:|---:|---:|
| multi/interleaved-clauses | 1 | 0% | 7.7 s |
| multi/same-due-date | 1 | 0% | 6.3 s |
| update/extend | 1 | 0% | 5.9 s |
| multi/disfluent-duration | 1 | 0% | 10.4 s |
| multi/self-correction-count | 1 | 0% | 8.0 s |
| chat-phrasing | 15 | 93% | 4.5 s |
| single/weekday | 1 | 100% | 4.5 s |
| single/spoken-time | 1 | 100% | 3.8 s |
| multi/same-list | 2 | 100% | 0.0 s |
| single/full-name | 1 | 100% | 0.1 s |
| task-not-event | 1 | 100% | 0.0 s |
| multi/same-day-3 | 2 | 100% | 11.7 s |
| recurring/weekly | 2 | 100% | 5.1 s |
| update/move-by-title | 1 | 100% | 0.0 s |
| query/today | 1 | 100% | 0.0 s |
| 3events+task | 1 | 100% | 16.4 s |
| past-tense-noise | 1 | 100% | 4.7 s |
| multi/shared-verb-3 | 1 | 100% | 0.0 s |
| single/due-weekday | 1 | 100% | 0.0 s |
| multi/different-days | 2 | 100% | 10.8 s |
| single/internal-and | 1 | 100% | 0.0 s |
| update/move-day | 1 | 100% | 0.0 s |
| query/week | 1 | 100% | 0.0 s |
| recurring/daily | 1 | 100% | 3.9 s |
| ambiguous/no-time | 1 | 100% | 6.0 s |
| event+task | 1 | 100% | 0.1 s |
| multi/same-day-2 | 3 | 100% | 9.4 s |
| multi/same-list-3 | 1 | 100% | 3.6 s |
| update/move-by-time | 1 | 100% | 5.0 s |
| event-not-task | 1 | 100% | 0.1 s |
| generated/single | 12 | 100% | 5.2 s |
| multi/shared-verb | 1 | 100% | 0.0 s |
| single/hebrew-name | 1 | 100% | 0.0 s |
| single/disfluency | 1 | 100% | 5.2 s |
| single | 2 | 100% | 0.0 s |
...
| single/hebrew-term | 2 | 100% | 4.0 s |
...
### events · multi/disfluent-duration · `llm` · 10.4 s
...
### events · multi/self-correction-count · `llm` · 8.0 s
...
### tasks · multi/same-due-date · `hybrid` · 6.3 s
...
### tasks · multi/interleaved-clauses · `llm` · 7.7 s
...
### update-delete · update/extend · `hybrid` · 5.9 s
...
| 13.2 | llm | on thursday I have Shacharit at 6:30 am, a lecture at 10 and dinner with Danny a |
| 12.2 | hybrid | set lunch with Tal on monday at noon and coffee with Ezra on friday at 9 |
| 11.0 | llm | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 10.4 | llm | set a meeting at 4pm today, but it is only 20 minutes meeting with one moment me |
| 10.2 | llm | set a meeting tomorrow at 1 pm, another one at 4 pm and then pizza at 6:30 pm to |
| 10.1 | llm | tomorrow gym at 7 am and a meeting with Tal at 11 |
| 9.4 | llm | two events tomorrow, one at four o'clock meeting with Rei and one at seven pm pi |
| 9.3 | llm | meeting with Ravid tomorrow at 2 pm and dentist on thursday at 9 am |
| 8.9 | llm | sadna on sunday the 15th at 9 am then driving lesson at 8 am |

## Raw

Full per-case JSON: `DOCUMENTATION/experiments/memory_scaling/C_60_k4.md.json`