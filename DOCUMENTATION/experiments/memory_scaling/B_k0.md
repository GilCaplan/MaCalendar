...
_Generated 2026-09-03 14:51 · 92 commands · scratch DB · vocabulary 374 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Time to first result:** p50 7.9 s · p95 17.1 s  ·  **time to settled:** p50 20.0 s · p95 29.6 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| adversarial | 5 | 100% | 100% | 100% | 100% | 7.9 s | 10.3 s | 19.5 s |
| events | 41 | 95% | 95% | 93% | 100% | 10.2 s | 17.5 s | 22.5 s |
| from-chats | 15 | 87% | 87% | 88% | 100% | 9.2 s | 16.8 s | 22.0 s |
| mixed | 3 | 100% | 100% | 100% | 100% | 0.1 s | 18.9 s | 11.1 s |
| query | 3 | 100% | 100% | 100% | 100% | 0.0 s | 0.0 s | 9.6 s |
| tasks | 18 | 89% | 89% | 95% | 79% | 0.0 s | 9.7 s | 12.8 s |
| update-delete | 7 | 86% | 86% | 86% | 100% | 0.0 s | 12.7 s | 13.4 s |

## By parse path

| Path | n | quick ✓ | settled ✓ | recall | precision | first p50 | first p95 | LLM ms p50 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| rule | 39 | 97% | 97% | 98% | 100% | 0.0 s | 4.9 s | 0 |
| hybrid | 8 | 75% | 75% | 90% | 91% | 9.4 s | 15.1 s | 9312 |
| llm | 45 | 91% | 91% | 90% | 94% | 10.9 s | 18.4 s | 10808 |

## Quick answer vs self-check

- Self-check ran on 92 commands; it proposed a correction on 6 (0 applied).
...
|---|---:|---:|---:|
| multi/self-correction-count | 1 | 0% | 12.7 s |
| multi/disfluent-duration | 1 | 0% | 16.2 s |
| multi/interleaved-clauses | 1 | 0% | 11.4 s |
| multi/same-due-date | 1 | 0% | 9.4 s |
| update/move-by-time | 1 | 0% | 9.4 s |
| chat-phrasing | 15 | 87% | 9.2 s |
| single/inferred-tag | 1 | 100% | 0.0 s |
| generated/single | 12 | 100% | 11.0 s |
| multi/same-day-3 | 2 | 100% | 17.7 s |
| single | 2 | 100% | 0.0 s |
| single/range | 1 | 100% | 11.5 s |
| query/week | 1 | 100% | 0.0 s |
| past-tense-noise | 1 | 100% | 10.7 s |
| multi/same-list | 2 | 100% | 0.0 s |
| multi/different-days | 2 | 100% | 16.7 s |
| recurring/weekly | 2 | 100% | 9.9 s |
| query/today | 1 | 100% | 0.0 s |
| single/day-of-month | 1 | 100% | 8.5 s |
| multi/different-due-dates | 1 | 100% | 9.3 s |
| delete/by-title | 1 | 100% | 0.0 s |
| update/extend | 1 | 100% | 14.0 s |
| single/due-weekday | 1 | 100% | 0.0 s |
| single/hebrew-name | 1 | 100% | 0.0 s |
| single/spoken-time | 1 | 100% | 9.8 s |
| task-not-event | 1 | 100% | 0.0 s |
| recurring/daily | 1 | 100% | 7.7 s |
| multi/tagged | 1 | 100% | 0.0 s |
| update/move-day | 1 | 100% | 0.0 s |
| multi/different-days-3 | 1 | 100% | 17.5 s |
...
### events · multi/disfluent-duration · `llm` · 16.2 s
...
### events · multi/self-correction-count · `llm` · 12.7 s
...
### tasks · multi/same-due-date · `hybrid` · 9.4 s
...
### tasks · multi/interleaved-clauses · `llm` · 11.4 s
...
### update-delete · update/move-by-time · `hybrid` · 9.4 s
...
### from-chats · chat-phrasing · `llm` · 7.9 s
...
| s | path | command |
|---:|---|---|
| 28.2 | llm | night shift tomorrow from 8 pm to 6 am |
| 21.0 | llm | tomorrow: Shacharit at 6:30, Haxaga TA at 12, dinner with Ezra at 8 pm, and remi |
| 18.6 | llm | set a meeting tomorrow at 1 pm, another one at 4 pm and then pizza at 6:30 pm to |
| 18.0 | hybrid | set lunch with Tal on monday at noon and coffee with Ezra on friday at 9 |
| 17.5 | llm | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 16.7 | llm | on thursday I have Shacharit at 6:30 am, a lecture at 10 and dinner with Danny a |
| 16.2 | llm | set a meeting at 4pm today, but it is only 20 minutes meeting with one moment me |
| 15.3 | llm | meeting with Ravid tomorrow at 2 pm and dentist on thursday at 9 am |
| 14.8 | llm | meeting with Tal on monday at 9 am about Netivim |
| 14.5 | llm | two events tomorrow, one at four o'clock meeting with Rei and one at seven pm pi |

## Raw

Full per-case JSON: `DOCUMENTATION/experiments/memory_scaling/B_k0.md.json`