...
_Generated 2026-09-08 23:31 · 25 commands · scratch DB · vocabulary 375 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Time to first result:** p50 0.1 s · p95 12.6 s  ·  **time to settled:** p50 0.1 s · p95 12.6 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| events | 25 | 76% | 76% | 81% | 97% | 0.1 s | 12.6 s | 0.1 s |

## By parse path

| Path | n | quick ✓ | settled ✓ | recall | precision | first p50 | first p95 | LLM ms p50 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| deep | 11 | 82% | 82% | 86% | 95% | 7.2 s | 15.1 s | 5430 |
...
- Findings: 7 (extra, missing) across 3 command(s); loop-backs on 0 command(s) (0 re-entries total).
...
|---|---:|---:|---:|
| single/disfluency | 1 | 0% | 17.6 s |
| single/hebrew-term | 2 | 0% | 0.1 s |
| single/terse | 1 | 0% | 0.0 s |
| multi/different-days-3 | 1 | 0% | 12.6 s |
...
### events · single/disfluency · `deep` · 17.6 s
...
### events · multi/different-days-3 · `deep` · 12.6 s
...
| s | path | command |
|---:|---|---|
| 17.6 | deep | meeting tomorrow at 2 sorry not 2, 3 pm with Adin for the project |
| 12.7 | deep | set a meeting tomorrow at 1 pm, another one at 4 pm and then pizza at 6:30 pm to |
| 12.6 | deep | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 10.6 | deep | walk Kyra the dog at 3:30 pm today and then go to shul for Mincha Maariv at 7:30 |
| 8.9 | deep | lunch with Tal at noon on the 19th |
| 7.2 | deep | book a haircut for tuesday at half past two |
