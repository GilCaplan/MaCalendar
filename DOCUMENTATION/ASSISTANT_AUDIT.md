...
_Generated 2026-09-03 23:53 · 94 commands · scratch DB · vocabulary 374 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Time to first result:** p50 5.7 s · p95 25.7 s  ·  **time to settled:** p50 5.7 s · p95 25.7 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| adversarial | 7 | 100% | 100% | 100% | 100% | 5.9 s | 7.5 s | 5.9 s |
| events | 41 | 95% | 95% | 96% | 98% | 6.9 s | 34.9 s | 6.9 s |
| from-chats | 15 | 100% | 100% | 100% | 100% | 6.5 s | 17.2 s | 6.5 s |
| mixed | 3 | 100% | 100% | 100% | 100% | 0.1 s | 23.9 s | 2.9 s |
| query | 3 | 100% | 100% | 100% | 100% | 0.0 s | 0.0 s | 1.3 s |
| tasks | 18 | 83% | 83% | 89% | 68% | 0.0 s | 22.4 s | 1.8 s |
| update-delete | 7 | 100% | 100% | 100% | 100% | 0.0 s | 7.5 s | 1.8 s |

## By parse path

| Path | n | quick ✓ | settled ✓ | recall | precision | first p50 | first p95 | LLM ms p50 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| deep | 55 | 91% | 91% | 95% | 88% | 7.2 s | 30.0 s | 5163 |
...
| vocab | 94/94 | 13 | 25 |
| rule | 93/94 | 14 | 55 |
| llm | 55/94 | 5163 | 22221 |
| validate | 18/94 | 1 | 12 |
| execute | 90/94 | 4 | 11 |
| verify | 55/94 | 1958 | 10250 |
...
- Findings: 12 (missing) across 5 command(s); loop-backs on 5 command(s) (12 re-entries total).
...
|---|---:|---:|---:|
| multi/disfluent-duration | 1 | 0% | 34.9 s |
| multi/same-due-date | 1 | 0% | 8.4 s |
| multi/interleaved-clauses | 1 | 0% | 21.4 s |
| multi/same-list-3 | 1 | 0% | 27.9 s |
| multi/same-day-2 | 3 | 67% | 14.3 s |
| multi/tagged | 1 | 100% | 0.0 s |
| query/today | 1 | 100% | 0.0 s |
| multi/shared-verb-people | 1 | 100% | 0.0 s |
| past-tense-noise | 1 | 100% | 7.6 s |
| multi/self-correction-count | 1 | 100% | 92.7 s |
| delete/by-time | 1 | 100% | 0.0 s |
| update/rename | 1 | 100% | 0.0 s |
| multi/shared-verb | 1 | 100% | 0.0 s |
| recurring/daily | 1 | 100% | 5.9 s |
| generated/single | 12 | 100% | 7.2 s |
| query/week | 1 | 100% | 0.0 s |
| misheard-names | 1 | 100% | 7.0 s |
| multi/shared-verb-3 | 1 | 100% | 0.1 s |
| single/hebrew-term | 2 | 100% | 5.5 s |
| update/extend | 1 | 100% | 8.2 s |
...
| multi/same-day-3 | 2 | 100% | 19.3 s |
| 3events+task | 1 | 100% | 26.5 s |
| chat-phrasing | 15 | 100% | 6.5 s |
| single/hebrew-name | 1 | 100% | 0.0 s |
| single/spoken-time | 1 | 100% | 5.5 s |
| single/weekday | 1 | 100% | 5.6 s |
| single/inferred-tag | 1 | 100% | 0.0 s |
| multi/different-days | 2 | 100% | 13.1 s |
...
| observance-meal-ok | 1 | 100% | 7.1 s |
...
| multi/different-due-dates | 1 | 100% | 11.9 s |
| ambiguous/no-time | 1 | 100% | 5.2 s |
...
### events · multi/same-day-2 · `deep` · 67.0 s
...
### events · multi/disfluent-duration · `deep` · 34.9 s
...
- **Did:** ['create_event', 'create_event', 'create_event'] — Created event 'meeting' on Thursday, Sep 3, 2026 from 4 PM to 5 PM. Created event 'Meeting with Reards' on Thursday, Sep 3, 2026 from 4 PM to 5 PM. Created even
- extra actions ['create_event']
- no event matching {'date': '2026-09-03', 'start_time': '16:00', 'end_time': '16:20'} in DB [('meeting', '2026-09-03', '16:00'), ('Meeting with Reards', '2026-09-03', '16:00'), ('Meeting with kids', '2026-09-03', '18:00')]

### tasks · multi/same-list-3 · `deep` · 27.9 s
...
### tasks · multi/interleaved-clauses · `deep` · 21.4 s
...
| s | path | command |
|---:|---|---|
| 92.7 | deep | a meeting for me tomorrow at two one sorry one pm and four pm and then another o |
| 67.0 | deep | two events tomorrow, one at four o'clock meeting with Rei and one at seven pm pi |
| 34.9 | deep | set a meeting at 4pm today, but it is only 20 minutes meeting with one moment me |
| 27.9 | deep | add tasks: submit the Haxaga grades, prepare Netivim slides, pay rent |
| 26.5 | deep | tomorrow: Shacharit at 6:30, Haxaga TA at 12, dinner with Ezra at 8 pm, and remi |
| 25.3 | deep | on thursday I have Shacharit at 6:30 am, a lecture at 10 and dinner with Danny a |
| 21.4 | deep | [TASKS VIEW] i need to buy some groceries, i need rice and chicken, the chicken  |
| 20.8 | deep | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 19.9 | deep | bowling tuesday night for Rei's birthday |
| 16.1 | deep | sadna on sunday the 15th at 9 am then driving lesson at 8 am |
