...
from assistant.engine.validate import named_weekdays as _named_weekdays, unsupported_cadence as _unsupported_cadence
...
def test_until_excludes_the_day_it_names(text):
    ...
    from assistant.engine.validate import end_is_exclusive as _end_is_exclusive
