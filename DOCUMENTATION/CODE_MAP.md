...
| Voice command goes to LLM instead of fast path | `RULE_THRESHOLD = 0.80` (whole-command) / `SUBITEM_RULE_THRESHOLD = 0.60` (per-fragment) — tuned 2026-09-07; check confidence in `RuleParseResult` |
