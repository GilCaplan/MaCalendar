...
_Generated 2026-09-03 22:59 · 92 commands · scratch DB · vocabulary 374 words · machine arm64. Re-run: `python -m scripts.audit_assistant`._
...
- **Recall 93%** (105/113 expected items produced correctly) · **precision 96%** (110/113 produced actions were expected, plus 2 extra task rows beyond what was expected) — accuracy alone doesn't distinguish missing something asked for from producing something extra
- **Time to first result:** p50 4.8 s · p95 10.9 s  ·  **time to settled:** p50 15.3 s · p95 22.6 s
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| adversarial | 5 | 100% | 100% | 100% | 100% | 5.1 s | 6.7 s | 16.3 s |
| events | 41 | 95% | 95% | 95% | 100% | 5.7 s | 11.1 s | 16.1 s |
| from-chats | 15 | 93% | 93% | 94% | 100% | 5.0 s | 8.5 s | 15.8 s |
| mixed | 3 | 100% | 100% | 100% | 100% | 0.1 s | 12.5 s | 7.4 s |
| query | 3 | 100% | 100% | 100% | 100% | 0.0 s | 0.0 s | 2.7 s |
| tasks | 18 | 83% | 83% | 84% | 78% | 0.0 s | 7.8 s | 5.1 s |
| update-delete | 7 | 86% | 86% | 86% | 100% | 0.0 s | 5.6 s | 5.8 s |
...
| hybrid | 9 | 67% | 67% | 73% | 91% | 6.5 s | 9.7 s | 6474 |
| llm | 44 | 93% | 93% | 93% | 94% | 5.8 s | 11.8 s | 5732 |

## Quick answer vs self-check

- Self-check ran on 92 commands; it proposed a correction on 52 (0 applied).
...
| past-tense-noise | 1 | 100% | 6.6 s |
| multi/different-days | 2 | 100% | 9.7 s |
| multi/same-day-2 | 3 | 100% | 7.6 s |
| recurring/daily | 1 | 100% | 5.3 s |
| single/next-weekday | 1 | 100% | 2.5 s |
...
| single/terse | 1 | 100% | 5.6 s |
| task+event | 1 | 100% | 0.1 s |
| update/move-by-time | 1 | 100% | 5.4 s |
| single | 2 | 100% | 0.0 s |
| multi/different-days-3 | 1 | 100% | 12.0 s |
| single/weekday | 1 | 100% | 5.7 s |
...
### events · multi/disfluent-duration · `llm` · 10.9 s
...
### events · multi/self-correction-count · `llm` · 10.2 s
...
### tasks · multi/same-due-date · `hybrid` · 7.4 s
...
### tasks · multi/different-due-dates · `hybrid` · 5.7 s
...
### tasks · multi/interleaved-clauses · `llm` · 10.1 s
...
### update-delete · update/extend · `hybrid` · 5.7 s
...
### from-chats · chat-phrasing · `rule` · 4.3 s
...
| s | path | command |
|---:|---|---|
| 13.9 | llm | tomorrow: Shacharit at 6:30, Haxaga TA at 12, dinner with Ezra at 8 pm, and remi |
| 12.8 | llm | set a meeting tomorrow at 1 pm, another one at 4 pm and then pizza at 6:30 pm to |
| 12.0 | llm | gym tomorrow at 6 am, tuesday at 6 am and friday at 6 am |
| 11.1 | hybrid | set lunch with Tal on monday at noon and coffee with Ezra on friday at 9 |
| 10.9 | llm | set a meeting at 4pm today, but it is only 20 minutes meeting with one moment me |
| 10.9 | llm | night shift tomorrow from 8 pm to 6 am |
| 10.2 | llm | a meeting for me tomorrow at two one sorry one pm and four pm and then another o |
| 10.1 | llm | [TASKS VIEW] i need to buy some groceries, i need rice and chicken, the chicken  |
| 9.4 | llm | two events tomorrow, one at four o'clock meeting with Rei and one at seven pm pi |
| 9.4 | llm | on thursday I have Shacharit at 6:30 am, a lecture at 10 and dinner with Danny a |

## Raw

Full per-case JSON: `DOCUMENTATION/experiments/memory_scaling/C_3000_k4.md.json`